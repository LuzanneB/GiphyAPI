$(document).ready(function () {
  ...
  function displayGif() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + gifOutput + "&api_key=0anDkstfLhUnDoq0WlArC7SckFK8E9Ea&limit=10&rating=g";
    // Ajax call
    $.ajax({
      url: queryURL,
      method: "GET"
  ...
  $("#phrase").on("click", function (event) {
    ...
    // Calling renderButtons which handles the processing of our sayings array
    renderButtons();
  });
